            ...
            <div className="flex justify-center mb-6">
                ...
                {!image ? (
                    <div className='w-20 h-20 flex items-center justify-center bg-purple-300 rounded-full relative'>
                        ...
                        <button type="button" onClick={onChooseFile} className='w-8 h-8 flex items-center justify-center bg-primary text-white rounded-full absolute -bottom-1 -right-1 hover:cursor-pointer'>
                            <LuUpload />
                        </button>
                    </div>
                ) : (
